...
export const CLIENTS: Client[] = [
  ...
  {
    slug: "amsterdam-manor",
    name: "Amsterdam Manor",
    industry: "Hospitalidad / Aruba",
    status: "prospect",
    priority: "high",
    prototypeUrl: "http://amsterdam-manor-beach-demo.vercel.app/",
    drivePath: "rr_aliados/06_Clientes/Amsterdam",
    tags: ["hospitalidad", "aruba", "prototipo-web"],
    notes: "Parte del prospecto Amsterdam ×3 (Aruba).",
  },
  {
    slug: "passion-on-the-beach",
    name: "Passion on the Beach",
    industry: "Hospitalidad / Aruba",
    status: "prospect",
    priority: "high",
    prototypeUrl: "https://passion-on-the-beach-demo.vercel.app/",
    drivePath: "rr_aliados/06_Clientes/Amsterdam",
    tags: ["hospitalidad", "aruba", "prototipo-web"],
    notes: "Parte del prospecto Amsterdam ×3 (Aruba).",
  },
  {
    slug: "horizons-lounge",
    name: "Horizons Lounge",
    industry: "Hospitalidad / Aruba",
    status: "prospect",
    priority: "high",
    prototypeUrl: "https://horizons-lunge-demo.vercel.app/",
    drivePath: "rr_aliados/06_Clientes/Amsterdam",
    tags: ["hospitalidad", "aruba", "prototipo-web"],
    notes: "Parte del prospecto Amsterdam ×3 (Aruba).",
  },
